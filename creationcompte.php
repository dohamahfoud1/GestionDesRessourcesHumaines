...
<body>
 ...
 <div class="container">
        ...
        <form id="" name="" method="post"  enctype="multipart/form-data" action="ajouter_employe.php" >
    <div class="row" >
    <div class="container-fluid ">  
                    <img src="employé.png" style="width: 20%; text-align: center; margin-left: 40%;margin-top: -5%;margin-bottom: 3%;" alt="CoolBrand">                
            </div>
    <div class="form-group">
                        <input type="int" name="matricule" class="form-control item" id="matricule" maxlength="4" placeholder="Matricule">
                    </div>
                    <div class="form-group">

<?php
  ...
  $requete="select * from primes where indemnite='réguliére' and( matricule like '%$nomE%' or type like '%$nomE%' or date like '%$nomE%')";
...
<style>
 ...
 <link href="navbar-top.css" rel="stylesheet">
  ...
  <form method="post" action="ajouterreguliere.php" class="form"   >
  <div class="modal fade" id="ajoutreguliere" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="col-md-6">
  <form method="get" action="reguliere.php">

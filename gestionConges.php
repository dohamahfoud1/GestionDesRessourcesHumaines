<?php
  ...
  $requete="select * from conges where matricule like '%$nomE%' or datedebut like '%$nomE%' or datefin like '%$nomE%' "; // la table conges contient les conges accepter par l'administrateur 
...
<style>
 ...
 <link href="navbar-top.css" rel="stylesheet">
  ...
  <div class="row">
      <div class="col-md-6">
        <form method="poste" action="gestionConges.php">
  <div class="input-group  " style="margin-top:15%;margin-bottom:10%;">
  <input type="text" name="nomE" class="form-control rounded" placeholder="chercher un conger"  />
  <button type="submit" id="submitBtn" style="background:#007ba1;color:white;" class="btn ">chercher</button>
    ...
    <div class="panel-body">
        ...
        <tbody>
            ...
            <tr class=lignecolor>
            <td ><?php echo $conges['matricule'] ?></td>
            ...
            <td>
            <a onclick="return confirm('Etes vous sûr de vouloir supprimer le congé')" href="supp_conge_accepter.php?idconge=<?php echo $conges['idconge']?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td>
            </tr>
            <?php } ?>
            </tbody>
        </table>

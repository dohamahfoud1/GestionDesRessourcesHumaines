   ...
   color:white;
    ...
    <div class="registration-form "  >
            <div class="row container">
                <div class="col-md-12" >
                <form method="post" action="salaireImposable.php" style="background-color: rgb(184, 50, 75);margin-top:-5%;">
                <div class="row">
                       <div class="col-md-3">
        ...
        <div class="row" >
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="float" name="cnss" class="form-control item" value="<?php echo isset($cnss) ? $cnss : '' ?>" >
                </div>
                </div>
                <div class="col-md-6">
                <div class="form-group">
                    <label for="">Calcul CNSS</label>
                    <input type="float" name="calculCnss" class="form-control item" id="primeT" value="<?php echo isset($Tcnss) ? $Tcnss : '' ?>">
                </div>
                </div>
        </div>

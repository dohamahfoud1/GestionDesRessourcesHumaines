...
<!-- Modal -->
<form method="post" action="ajouter_reunion.php" class="form" >
<div class="modal fade" id="ajoutreunion" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div>
    ...
    <button type="button" class="btn " data-bs-toggle="modal" data-bs-target="#ajoutreunion"  style="margin-top:50%;background-color: #007ba1;color:white;">
  Ajouter une réunion
</button>
    ...
    <div class="panel-body">
        ...
        <tbody>
            ...
            <td>
            <a  href="modif_reunion.php?idreunion=<?php echo $reunion['idreunion']?>"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            <a onclick="return confirm('Etes vous sûr de vouloir supprimer la réunion')" href="supp_reunion.php?idreunion=<?php echo $reunion['idreunion']?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td>
            </tr>
            <?php } ?>
            </tbody>
        </table>

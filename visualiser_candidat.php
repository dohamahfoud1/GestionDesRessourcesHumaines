     	...
     	<div class="row d-flex justify-content-center" style="margin-top:-150px">
            <div class="col-md-10 mt-5 pt-5">
             	<div class="row z-depth-3" >
                 	<div class="col-sm-4  rounded-left" style="background-color:rgb(0, 98, 98);">
                        ...
                        <div class="row">
                        	...
                        	<div class="col-sm-6">
                            	<p class="font-weight-bold">Genre:</p>
                           		<h6 class="text-muted"><?php echo $candidats['situation'];?></h6>
                        	</div>
                    	</div>
                    		<h4 class="mt-3"></h4>
                    		<hr class="bg-primary">
                   		<div class="row">
                        	...
                        	<div class="col-sm-6">
                            	<p class="font-weight-bold">Secteur</p>
                            	<h6 class="text-muted"><?php echo $candidats['secteur'];?></h6>
                        	</div>
                    	</div>
						<div class="row">
                           		<p class="font-weight-bold">Région</p>
                          	  	<h6 class="text-muted"><?php echo $candidats['region'];?></h6>
                    	</div>
                        <h4 class="mt-3">DOCUMENT ATTACHÉ</h4>
                   		...
                   		<div class="row">
                        	<div class="col-sm-6">
                          	  ...
                          	  <h6 class="text-muted"><?php echo $candidats['cv'];?></h6><a href="telechargement_cv.php?id=<?php  echo $candidats['idcand'];?>" ><i class="material-icons" data-toggle="tooltip" title="download">file_download</i></a>
                        	</div>
                    	</div>
                	   	<hr class="bg-primary">
                	    <ul class="list-unstyled d-flex justify-content-center mt-4">
                            <a style="background-color:rgb(0, 98, 98);padding: 10px 18px;text-decoration: none;color: #fff;display: inline-block;margin: 30px 0;border-radius: 5px;" href="email_de_confir.php?id=<?php  echo $candidats['idcand'];?>">Envoyer un email de confirmation</a>
	               		</ul>  
              		</div>
             	</div>
            </div>
